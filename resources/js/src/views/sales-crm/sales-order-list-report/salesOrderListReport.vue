                ...
                <div class="custom-search">
                    ...
                    <b-row>
                        <b-col md="3">
                            <b-form-group
                                label="Party"
                                label-for="sellToPartyCustomerID"
                            >
                                <v-select
                                    v-model="serverParams.sellToPartyCustomerID"
                        ...
                        <b-col md="3">
                            ...
                            >
                                <v-select
                                    v-model="serverParams.salesOrderBranch"
                        ...
                        <b-col md="3">
                            ...
                            >
                                <v-select
                                    v-model="serverParams.salesOrderSalesType"
                        ...
                        <b-col md="3">
                            ...
                            >
                                <v-select
                                    v-model="serverParams.salesOrderStatus"
                        ...
                        <b-col md="3">
                            ...
                            >
                                <v-select
                                    ...
                                    v-model="serverParams.salesOrderType"
                                />
                            </b-form-group>
                        </b-col>
                            ...
                            <b-button-toolbar justify>
                                <b-button-group>
                                    <b-button
                                        ...
                                        @click="exportDataToExcel(columns, rows, 'sales_order_list.xlsx', 'sales_order_list')"
                                    >
                                    ...
                                    <b-button
                                        v-ripple.400="'rgba(113, 102, 240, 0.15)'"
                                        variant="outline-primary"
                                        @click="exportTableDataToPdf(columns, rows, 'sales_order_list.pdf')"
                                    >
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const fealdFn = (rowObj) => {

              return "Customer Name: "+rowObj.sellToPartyCustomerName + ", Po.No: " + rowObj.customerPoNo + ", Project: " + rowObj.salesOrderProject
            ...
            const columns = ref([
                ...
                {
                    label: 'Customer Name, P.O. No. & Project',
                    field: fealdFn,
                },
                {
            ...
            axios.get('/api/get-sales-order-type-options').then(res => {
            ...
            const refetchData = async () => {
                ...
                await axios.post('/api/get-sales-order-list-with-filter', {
                    ...serverParams.value,
                })
                    .then(res => {
