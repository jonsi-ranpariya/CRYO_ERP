            ...
            <b-col md="6">
                ...
                >
                    <b-form-input
                        ...
                        v-model="loginData.prepareDateTime"
                        readonly
                    />
                </b-form-group>
                <b-form-group
            ...
            <b-col md="6">
                ...
                >
                    <v-select
                        ...
                        :reduce="val => val.value"
                        v-model="loginData.instructedBy"
                    />
                </b-form-group>
                <b-form-group
                ...
                >
                    <b-form-input
                        type="text"
                        v-model="loginData.instructedByName"
                    />
                </b-form-group>
                <b-form-group
                    label="Follow Up By"
                ...
                >
                    <b-form-input
                        type="text"
                        v-model="loginData.followUpByName"
                    />
                </b-form-group>
            </b-col>
        </b-row>
