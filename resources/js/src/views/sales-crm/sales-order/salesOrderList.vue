                ...
                <b-card-code class="mt-1">
                    ...
                    >
                        ...
                        >
                            ...
                            <!-- Column: Name -->
                            <span
                                v-if="props.column.field === 'salesOrderNo'"
                                class="text-nowrap"
                            >
                          <span class="text-nowrap">{{ props.row.salesOrderNo }}</span>
                        </span>
                            ...
                            >
                              ...
                              <b-dropdown-item :to="{ name: 'edit-sales-order', params: { id: props.row._id} }">
                                <feather-icon
                                    icon="Edit2Icon"
                                    class="mr-50"
                                />
    ...
    export default {
        ...
        data() {
            const refetchData = () => {
                ...
                this.$http.get('/api/sales-order').then(res => {
            ...
            return {
                ...
                columns: [
                    {
                        label: 'Party Code',
                        field: 'sellToPartyCustomerCode',
                    },
                    {
                        label: 'Party Name',
                        field: 'sellToPartyCustomerName',
                    },
                    {
                        label: 'P.O No',
                        field: 'customerPoNo',
        ...
        methods: {
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`sales-order-module/deleteSalesOrder`, {id}).then(response => {
            ...
            async applyFilter() {
                this.showOverlayLoading = true
                await this.$http.post('/api/get-sales-order-filter-wise', this.searchForm).then((res) => {
                    this.rows = res.data.data
                })
                this.showOverlayLoading = false
            },
            resetSearchFormData() {
                ...
                this.searchForm.partyName = null
