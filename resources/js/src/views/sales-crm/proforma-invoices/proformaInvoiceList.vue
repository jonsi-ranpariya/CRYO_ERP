        ...
        perPage:pageLength
          ...
          <span>
            ...
            >
              ...
              <b-dropdown-item :to="{ name: 'edit-proforma-invoices', params: { id: props.row._id} }">
                <feather-icon
                    icon="Edit2Icon"
                    class="mr-50"
                />
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/proforma-invoices').then(res => {
            ...
            return {
                ...
                columns: [
                    ...
                    {
                        label: 'Party Code',
                        field: 'pInvoiceCustomerCode',
                    },
                    {
                        label: 'Party Name',
                        field: 'pInvoiceCustomerName',
                    },
                    {
                        label: 'Net Amount',
                        field: 'net_amount',
        ...
        created() {
            ...
            this.$http.get('/api/proforma-invoices')
                .then(res => {
                    this.rows = res.data.data
                    this.showOverlayLoading = false
                })
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`proforma-invoices-module/deleteProformaInvoice`, {id}).then(response => {
