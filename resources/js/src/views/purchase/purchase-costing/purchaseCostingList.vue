            ...
            <b-card-code>
                <b-row class="mb-1">
                    <b-col cols="12" md="6" class="d-flex justify-content-start align-items-center">
                        <b-button
                            variant="primary"
                            :to="{ name: 'add-purchase-costing'}"
                        > Add Purchase Costing
                        </b-button>
                    </b-col>
                    <!-- ---------------search ---------------->
                    <b-col cols="12" md="6">
                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{ name: 'edit-purchase-costing', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deletePurchaseCosting(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const columns = ref([
                ...
                {
                    label: 'Country',
                    field: 'country_detail.country',
                },
                {
                    label: 'State',
                    field: 'state_detail.state',
                },
                {
                    label: 'District',
                    field: 'city_detail.city',
                },
                {
                    label: 'Action',
                    field: 'action',
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/purchase-costing').then(res => {
            ...
            const deletePurchaseCosting = async (id) => {
                await Swal.fire({
                    title: 'Are you sure?',
                    ...
                    if (result.value) {
                        store.dispatch('purchase-store-module/deletePurchaseCosting', {id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    component: Toastification,
                                    position: 'top-right',
                                    props: {
                                        title: 'Purchase Costing Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Purchase Costing',
                                    },
                                })
                            } else {
                                toast({
