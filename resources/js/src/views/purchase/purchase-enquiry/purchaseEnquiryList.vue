                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item
                              :to="{ name: 'edit-purchase-enquiry', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deletePurchaseEnquiry(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/purchase-enquiry').then((res) => {
            ...
            const deletePurchaseEnquiry = async (id) => {
                await Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Purchase Enquiry",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch('purchase-store-module/deletePurchaseEnquiry', {id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: 'You have successfully Deleted Purchase Enquiry',
                                    },
                                })
                            } else {
                                toast({
