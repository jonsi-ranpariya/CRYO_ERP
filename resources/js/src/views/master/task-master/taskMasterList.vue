    ...
    >
        <div>
            <task-master-add-new
                ...
                :auto-activity-alert-options="autoActivityAlertOptions"
                :auto-sms-alert-options="autoSmsAlertOptions"
                :auto-mail-alert-options="autoMailAlertOptions"
        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'taskName'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.taskName }}</span>
...
<script>
    ...
    import taskMasterAddNew from './taskMasterAddNew.vue'
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/task-master').then(res => {
            ...
            const autoActivityAlertOptions = [
                {label: 'No', value: 'No'},
                {label: 'Yes', value: 'Yes'},
                ]

            const autoSmsAlertOptions = [
                {label: 'No', value: 'No'},
                {label: 'Yes', value: 'Yes'},
            ]

            const autoMailAlertOptions = [
                {label: 'No', value: 'No'},
                {label: 'Yes', value: 'Yes'},
            ]
        ...
        setup() {
            ...
            const TASK_APP_STORE_MODULE_NAME = 'task-master-module'

            // Register module
            if (!store.hasModule(TASK_APP_STORE_MODULE_NAME)) store.registerModule(TASK_APP_STORE_MODULE_NAME, masterStoreModule)
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`task-master-module/deleteTaskMaster`, {id}).then(response => {
