            ...
            <b-col md="12">
                <b-tabs pills>
                    <b-tab active>
                        ...
                        <item-master-edit-item-details-tab
                    ...
                    <b-tab>
                        <template #title>
                            <feather-icon
                                ...
                                class="mr-0 mr-sm-50"
                            />
                            <span class="d-none d-sm-inline">HSN/SAC</span>
                        </template>
                        <item-master-edit-h-s-n-s-a-c-tab/>
                    </b-tab>
                    <b-tab>
                        <template #title>
                            <feather-icon
...
<script>
    ...
    import ItemMasterEditItemDetailsTab from "./tabs/ItemMasterEditItemDetailsTab";
    import ItemMasterEditPurchaseTab from "./tabs/itemMasterEditPurchaseTab";
    import ItemMasterEditGeneralTab from "./tabs/itemMasterEditGeneralTab";
    import ItemMasterEditHSNSACTab from "./tabs/itemMasterEditHSNSACTab";
    import axios from '@axios'
    import Swal from 'sweetalert2'
    import ItemMasterEditLoginTab from "./tabs/itemMasterEditLoginTab";

    export default {
        components: {
            ItemMasterEditLoginTab,
            ItemMasterEditHSNSACTab,
            ItemMasterEditGeneralTab,
            ItemMasterEditPurchaseTab,
            ItemMasterEditItemDetailsTab,
            BCardCode,
            ValidationProvider,
            ValidationObserver,
            BRow,
            ...
            const updateData = async () => {
                await store.dispatch('master-add/updateItemMaster', formData.value).then(() => {
                    toast({
                        ...
                        position: 'top-right',
                        props: {
                            title: 'Item Master Updated',
                            icon: 'CheckSquareIcon',
                            variant: 'success',
                            text: 'You have successfully Updated Item Master',
                        },
                    });
                    //router.push({name: 'item-master-list'})
                });
            }

            const submitFormData = async () => {
                await axios.post('/api/item-name-exist-with-id',
                    {
        ...
        methods: {
            ...
            async refetchData (e) {
                await this.$http.get(`/api/item-master/${router.currentRoute.params.id}`).then(res => {
                    this.formData = res.data.data
                    this.formData.id = res.data.data._id
                    delete this.formData._id
