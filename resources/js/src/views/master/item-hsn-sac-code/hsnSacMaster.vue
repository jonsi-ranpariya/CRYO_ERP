        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'codeDescription'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.codeDescription }}</span>
        </span>
          ...
          <span>
            ...
            >
              ...
              <b-dropdown-item :to="{ name: 'edit-hsn-sac-code', params: { id: props.row._id} }">
                <feather-icon
                    icon="Edit2Icon"
                    class="mr-50"
                />
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/item-hsn-sac-code').then(res => {
        ...
        setup() {
            ...
            const HSNSAC_APP_STORE_MODULE_NAME = 'hsnsac-module'
        ...
        created() {
            ...
            this.$http.get('/api/item-hsn-sac-code')
                .then(res => {
                    this.rows = res.data.data
                    this.showOverlayLoading = false
                })
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`hsnsac-module/deleteIHsnSacMaster`, {id}).then(response => {
                            ...
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `HSN/SAC Code Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
