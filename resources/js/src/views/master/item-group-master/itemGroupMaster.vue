        ...
        perPage:pageLength
          ...
          <span>
            ...
            >
              ...
              <b-dropdown-item :to="{ name: 'edit-item-group-master', params: { id: props.row._id} }">
                <feather-icon
                    icon="Edit2Icon"
                    class="mr-50"
                />
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/item-group-master').then(res => {
        ...
        created() {
            ...
            this.$http.get('/api/item-group-master')
                .then(res => {
                    this.rows = res.data.data
                    this.showOverlayLoading = false
                })
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`item-group-module/deleteItemGroupMaster`, {id}).then(response => {
                            ...
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Item Group Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
