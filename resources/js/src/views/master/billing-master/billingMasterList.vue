            ...
            <b-card-code>
                ...
                >
                    ...
                    >
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'valueType'"
                            class="text-nowrap"
                        >
                          <span class="text-nowrap">{{ props.row.valueType.label }}</span>
                        </span>
                        <!-- Column: Action -->
...
<script>
    ...
    import BillingMasterAddEdit from "./billingMasterAddEdit";

    export default {
        components: {
            BillingMasterAddEdit,
            BCardCode,
            BOverlay,
            VueGoodTable,
            BButton,
        ...
        data() {
            const refetchData = () => {
                ...
                this.$http.get('/api/billing-master').then(res => {
        ...
        setup() {
            const ITEMADDON_APP_STORE_MODULE_NAME = 'billing-master'
        ...
        methods: {
            ...
            deleteMyCurrentErpData(id) {
                this.$swal({
                    ...
                    if (result.value) {
                        store.dispatch(`billing-master/deleteBillingMaster`, {id}).then(response => {
                            if (response.data.status === 200) {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Billing Master Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
