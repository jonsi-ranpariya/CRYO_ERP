            ...
            <b-card-code>
                ...
                <b-row class="mb-2">
                    ...
                    >
                        ...
                        <b-button
                            variant="primary"
                            :to="{ name: 'add-invoice-type-master'}"
                        >
        ...
        perPage:pageLength
          ...
          <span>
            ...
            >
              ...
              <b-dropdown-item :to="{ name: 'edit-invoice-type-master', params: { id: props.row._id} }">
                <feather-icon
                    icon="Edit2Icon"
                    class="mr-50"
                />
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/invoice-type-master').then(res => {
        ...
        created() {
            ...
            this.$http.get('/api/invoice-type-master')
                .then(res => {
                    this.rows = res.data.data
                    this.showOverlayLoading = false
                })
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`inv-type-module/deleteInvoiceTypeMaster`, {id}).then(response => {
                            ...
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Invoice Type Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
