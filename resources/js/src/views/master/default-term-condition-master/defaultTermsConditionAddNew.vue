    ...
    >
        <template #default="{ hide }">
            ...
            <div class="d-flex justify-content-between align-items-center content-sidebar-header px-2 py-1">
                <h5 class="mb-0">
                    Add/Edit Default Term And Condition
                </h5>
                    ...
                    >
                        ...
                        >
                            <v-select
                                ...
                                :clearable="false"
                                id="tcGroup"
                                v-on:input="getTermsDetails(userformData.tcGroup)"
                            />
                        </b-form-group>
        ...
        methods: {
            ...
            getTermsDetails(id) {
                ...
                this.$http.get(`/api/term-condition-detail-master/${id}`).then(res => {
                    ...
                    this.userformData.tcDescription = res.data.data.tcGroupDescription
                    this.userformData.tcGroupName = res.data.data.tc_group_details.groupDescription
                })
            ...
            saveMyERPData() {
                ...
                if (hasIdExist) {
                    ...
                    store.dispatch('default-term-condition-module/updateDefaultTermsCondition', this.userformData).then(response => {
                        ...
                        if (response.status = 200) {
                            ...
                            this.$toast({
                                ...
                                props: {
                                    ...
                                    variant: 'success',
                                    text: `You have successfully Edited Detail : ${this.userformData.tcDescription}.`,
                                },
                            })
                        }
                    ...
                    store.dispatch('default-term-condition-module/addDefaultTermsCondition', this.userformData).then(response => {
                        ...
                        if (response.status = 200) {
                            ...
                            this.$toast({
                                ...
                                props: {
                                    ...
                                    icon: 'CheckSquareIcon',
                                    variant: 'success',
                                    text: `You have successfully Created New Term Detail : ${this.userformData.tcDescription}.`,
                                },
                            })
                        }
