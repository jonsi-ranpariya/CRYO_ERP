...
<script>
    ...
    export default {
            ...
            validationForm() {
                this.$refs.simpleRules.validate().then(success => {
                    if (success) {
                        ...
                        store.dispatch('so-type-module/UpdateSalesOrderTypeMaster', this.partyFormData).then(response => {
        ...
        setup() {
            ...
            store.dispatch('so-type-module/fetchSalesOrderTypeDetail', {id: router.currentRoute.params.id})
                .then(response => {
