            ...
            <b-card-code>
                ...
                <b-row class="mb-2">
                    ...
                    >
                        ...
                        <b-button
                            variant="primary"
                            :to="{ name: 'add-sales-order-type-master'}"
                        >
                            Add New Sales Order Type
                        </b-button>
                    </b-col>
                    <b-col
                        cols="12"
        ...
        perPage:pageLength
          ...
          <span>
            ...
            >
              ...
              <b-dropdown-item :to="{ name: 'edit-sales-order-type-master', params: { id: props.row._id} }">
                <feather-icon
                    icon="Edit2Icon"
                    class="mr-50"
                />
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/sales-order-type-master').then(res => {
        ...
        created() {
            ...
            this.$http.get('/api/sales-order-type-master')
                .then(res => {
                    this.rows = res.data.data
                    this.showOverlayLoading = false
                })
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`so-type-module/deleteSalesOrderTypeMaster`, {id}).then(response => {
