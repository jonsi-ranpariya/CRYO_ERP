    ...
    export default {
        ...
        setup(props) {
            ...
            const saveFormData = async () => {
                ...
                await store.dispatch('job-work-order-store-module/updateJobWorkRateMaster', sendData).then(res =>{
                    if (res.status === 200) {
                        toast({
                            component: ToastificationContent,
                            position: 'top-right',
                            props: {
                                title: 'Job Work Rate Master Sub-Contractor Details Updated',
                                icon: 'CheckSquareIcon',
                                variant: 'success',
                                text: 'You have successfully Updated Job Work Rate Master Sub-Contractor Details.',
                            },
                        })
                    } else {
                        toast({
                    ...
                    router.push({name: 'job-work-rate-master'})
                })
            }
