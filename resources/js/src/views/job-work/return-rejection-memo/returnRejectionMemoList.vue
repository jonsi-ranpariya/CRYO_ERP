        ...
        <b-card-code>
            <b-row class="mb-2">
                ...
                <b-col cols="12" md="6" class="justify-content-start d-flex align-items-center">
                    <b-button
                        variant="primary"
                        :to="{ name :'add-return-rejection-memo'}"
                    >
                        Add Return Rejection Memo
                    </b-button>
                </b-col>
                <!--search-->
                <b-col cols="12" md="6">
                    ...
                    <span v-if="props.column.field === 'action'">
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{ name: 'edit-return-rejection-memo', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item  @click="deleteJobWorkRejectionMemo(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const columns = ref([
                {
                    ...
                    field: 'jobWorkReturnNo',
                },
                {
                    label: 'Job Work Return Date',
                    field: 'jobWorkReturnDate',
                },
                {
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/new/return-rejection-memo').then(res => {
            ...
            const deleteJobWorkRejectionMemo = async (id) => {
                await Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Job Work Rejection Memo",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch('return-memo-store-module/deleteReturnRejectionMemo', {id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    component: Toastification,
                                    position: 'top-right',
                                    props: {
                                        title: 'Job Work Rejection Memo Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Job Work Rejection Memo',
                                    },
                                })
                            } else {
                                toast({
