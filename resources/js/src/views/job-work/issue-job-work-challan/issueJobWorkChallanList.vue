            ...
            <b-card-code>
                <b-row class="mb-1">
                    <b-col cols="12" md="6" class="d-flex justify-content-start align-items-center">
                        <b-button
                            variant="primary"
                            :to="{ name: 'add-issue-job-work-challan'}"
                        > Add Issue Job Work Challan
                        </b-button>
                    </b-col>
                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{ name: 'edit-issue-job-work-challan', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteIssueJobWorkChallan(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/issue-job-work-challan').then(res => {
            ...
            const deleteIssueJobWorkChallan = async (id) => {
                await Swal.fire({
                    title: 'Are you sure?',
                    ...
                    if (result.value) {
                        store.dispatch('issue-job-work-challan-store-module/deleteIssueJobWorkOrderChallan', {id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    component: Toastification,
                                    position: 'top-right',
                                    props: {
                                        title: 'Issue Job Work Challan Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Issue Job Work Challan',
                                    },
                                })
                            } else {
                                toast({
