            ...
            <b-card-code>
                <b-row class="mb-2">
                    ...
                    <b-col cols="12" md="6" class="justify-content-start d-flex align-items-center">
                        <b-button
                            variant="primary"
                            :to="{ name :'add-receipt-job-work-challan'}"
                        >
                            Add Receipt Job Work Challan
                        </b-button>
                    </b-col>
                    <!--search-->
                    <b-col cols="12" md="6">
                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item
                              :to="{ name: 'edit-receipt-job-work-challan', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteJobWorkChallan(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/new/receipt-job-work-challan').then(res => {
            ...
            const deleteJobWorkChallan = async (id) => {
                await Swal.fire({
                    title: 'Are you sure?',
                    ...
                    if (result.value) {
                        store.dispatch('receipt-job-challan-store-module/deleteReceiptJobWorkChallan', {id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    component: Toastification,
                                    position: 'top-right',
                                    props: {
                                        title: ' Receipt Job Work Challan Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Receipt Job Work Challan',
                                    },
                                })
                            } else {
                                toast({
