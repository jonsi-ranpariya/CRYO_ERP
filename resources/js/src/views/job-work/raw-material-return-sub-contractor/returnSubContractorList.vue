        ...
        <b-card-code>
            <b-row class="mb-1">
                <b-col cols="12" md="6" class="d-flex justify-content-start align-items-center">
                    <b-button
                        variant="primary"
                        :to="{ name: 'add-return-sub-contractor'}"
                    > Add Raw Material Sub Contractor
                    </b-button>
                </b-col>
                ...
                <span v-if="props.column.field === 'action'">
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{ name: 'edit-return-sub-contractor', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteRawMaterial(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
        ...
        setup() {
            ...
            const columns = ref([
                ...
                },
                {
                    ...
                    field: 'subContractorDetail.subContractorName',
                },
                {
                    label: 'Action',
                    field: 'action',
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/new/raw-material').then(res => {
            ...
            const deleteRawMaterial = async (id) =>{
                    await Swal.fire({
                        ...
                        if (result.value) {
                            store.dispatch('raw-material-store-module/deleteRawMaterial', {id: id}).then(res => {
                                if (res.status === 200) {
                                    toast({
                                        ...
                                        props: {
                                            ...
                                            variant: 'success',
                                            text: 'You have successfully Deleted Raw Material',
                                        },
                                    })
                                } else {
                                    toast({
