            ...
            <b-card-code>
                <b-row class="mb-1">
                    <b-col cols="12" md="6" class="d-flex justify-content-start align-items-center">
                        <b-button
                            variant="primary"
                            :to="{ name: 'add-outdoor-duty-by-manager'}"
                        > + Add Outdoor Duty By Manager
                        </b-button>
                    </b-col>
                    <!-- ---------------search ---------------->
                    <b-col cols="12" md="6">
                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{name: 'edit-outdoor-duty-by-manager', params:{id: props.row._id}}">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteOutdoorDutyByManagerData(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const deleteOutdoorDutyByManagerData = async (id) => {
                /*   Swal.fire({
                       title: 'Are you sure?',
                       text: "Delete Outdoor Duty By Manager",
                       icon: 'warning',
                       ...
                       if (result.value) {
                           store.dispatch(`hr-store-module/deleteOutdoorDutyByManager`, {id: id}).then(res => {
                               if (res.status === 200) {
                                   toast({
                                       component: Toastification,
                                       position: 'top-right',
                                       props: {
                                           title: 'Outdoor Duty By Manager Deleted',
                                           icon: 'CheckSquareIcon',
                                           variant: 'success',
                                           text: 'You have successfully Deleted Outdoor Duty By Manager',
                                       },
                                   })
                               } else {
                                   toast({
            ...
            return {
                ...
                columns,
                rows,
                deleteOutdoorDutyByManagerData,
