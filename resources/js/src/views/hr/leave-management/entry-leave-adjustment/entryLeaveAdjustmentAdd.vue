            ...
            <validation-observer #default="{handleSubmit}">
                <b-form @submit.prevent="handleSubmit(saveFormData)">
                    <b-row>
                        ...
                        <b-col md="5">
                            <h6><p class="text-danger">To reduce from balance input days in positive else input in
                                negative.</p></h6>
                        </b-col>
                        <b-col md="4">
                            <validation-provider
    ...
    export default {
        ...
        setup() {
            ...
            const saveFormData = async () => {
                ...
                /*
                await store.dispatch('hr-store-module/addLeaveAdjustment', formData.value)
                    .then(res => {
                        if (res.status === 200) {
                            toast({
