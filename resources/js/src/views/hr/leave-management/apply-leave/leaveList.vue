                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{name: 'edit-leave', params:{id: props.row._id}}">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteLeaveApplyData(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const deleteLeaveApplyData = async (id) => {
              /*  Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Apply Leave",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch(`hr-store-module/deleteLeave`, {id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    component: Toastification,
                                    position: 'top-right',
                                    props: {
                                        title: 'Apply Leave Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Apply Leave',
                                    },
                                })
                            } else {
                                toast({
