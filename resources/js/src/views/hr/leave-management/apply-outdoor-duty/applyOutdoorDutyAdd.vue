    ...
    export default {
        ...
        setup() {
            ...
            const saveFormData = async () => {
                ...
                /*    await store.dispatch('hr-store-module/addOutdoorDuty', formData.value)
                       .then(res => {
                           if (res.status === 200) {
                               toast({
                                   ...
                                   position: 'top-right',
                                   props: {
                                       title: 'Outdoor Duty Added',
                                       icon: 'CheckSquareIcon',
                                       variant: 'success',
                                       text: `You have successfully Added Outdoor Duty.`,
                                   },
                               })
                           } else {
                               toast({
