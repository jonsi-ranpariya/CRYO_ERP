                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{name: 'edit-leave-encashment', params:{id: props.row._id}}">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteLeaveEncashmentData(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const deleteLeaveEncashmentData = async (id) => {
                /*  Swal.fire({
                      title: 'Are you sure?',
                      text: "Delete Leave Encashment",
                      icon: 'warning',
                      ...
                      if (result.value) {
                          store.dispatch(`hr-store-module/deleteLeaveEncashment`, {id: id}).then(res => {
                              if (res.status === 200) {
                                  toast({
                                      component: Toastification,
                                      position: 'top-right',
                                      props: {
                                          title: 'Apply Leave Encashment Deleted',
                                          icon: 'CheckSquareIcon',
                                          variant: 'success',
                                          text: 'You have successfully Deleted Apply Leave Encashment',
                                      },
                                  })
                              } else {
                                  toast({
