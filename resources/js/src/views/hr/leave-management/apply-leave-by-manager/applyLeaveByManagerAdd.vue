    ...
    export default {
        ...
        setup() {
            ...
            const saveFormData = async () => {
                ...
                /*
                await store.dispatch('hr-store-module/addApplyLeaveByManager', formData.value)
                    .then(res => {
                        if (res.status === 200) {
                            toast({
                                ...
                                position: 'top-right',
                                props: {
                                    title: 'Apply Leave By Manager Added',
                                    icon: 'CheckSquareIcon',
                                    variant: 'success',
                                    text: `You have successfully Added Apply Leave By Manager.`,
                                },
                            })
                        } else {
                            toast({
