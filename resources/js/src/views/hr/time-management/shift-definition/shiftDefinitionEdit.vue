            ...
            <b-card-code>
                <b-tabs pills>
                    <b-tab active>
                        ...
                        <hr>
                        <general-tab
                            :generalSettingDetail="formData.generalSettingDetail"
                        />
                    </b-tab>
                    <b-tab>
                        <template #title>
                            <feather-icon
                                ...
                                class="mr-0 mr-sm-50"
                            />
                            <span class="d-none d-sm-inline">Slab</span>
                        </template>
                        <hr>
                        <slab-tab
                        />
                    ...
                    <b-tab>
                        <template #title>
                            <feather-icon
                                ...
                                class="mr-0 mr-sm-50"
                            />
                            <span class="d-none d-sm-inline">Late Mark</span>
                        </template>
                        <hr>
                        <late-mark-tab
                            :lateMarkDetail="formData.lateMarkDetail"
                        />
                    </b-tab>
                    <b-tab>
                        <template #title>
                            <feather-icon
                                ...
                                class="mr-0 mr-sm-50"
                            />
                            <span class="d-none d-sm-inline">Day Work</span>
                        </template>
                        <hr>
                        <day-work-tab
                            :dayWorkDetails="formData.dayWorkDetails"
                        />
                    </b-tab>
                    <b-tab>
                        <template #title>
                            <feather-icon
                                ...
                                class="mr-0 mr-sm-50"
                            />
                            <span class="d-none d-sm-inline">Over Time</span>
                        </template>
                        <hr>
                        <over-time-tab
                            :overTimeDetails="formData.overTimeDetails"
                        />
                    </b-tab>
                    <b-tab>
                        <template #title>
                            <feather-icon
                                ...
                                class="mr-0 mr-sm-50"
                            />
                            <span class="d-none d-sm-inline">Late Time</span>
                        </template>
                        <hr>
                        <late-time-tab
                            :lateTimeDetails="formData.lateTimeDetails"
                        />
                    </b-tab>
                    <b-tab>
                        <template #title>
                            <feather-icon
                                ...
                                class="mr-0 mr-sm-50"
                            />
                            <span class="d-none d-sm-inline">CO +</span>
                        </template>
                        <hr>
                        <co-plus-tab
                            :coPlusDetails="formData.coPlusDetails"
                        />
                    </b-tab>
                    <b-tab>
                        <template #title>
                            <feather-icon
                                ...
                                class="mr-0 mr-sm-50"
                            />
                            <span class="d-none d-sm-inline">Allow Filter's</span>
                        </template>
                        <hr>
                        <allow-filters-tab
                            :filterDetails="formData.filterDetails"
                        />
                    </b-tab>
                </b-tabs>
            </b-card-code>
...
<script>
    ...
    import slabTab from './tabs/slabTab'
    import lateMarkTab from './tabs/lateMarkTab'
    import dayWorkTab from './tabs/dayWorkTab'
    import overTimeTab from './tabs/overTimeTab'
    import lateTimeTab from './tabs/lateTimeTab'
    import coPlusTab from './tabs/coPlusTab'
    import allowFiltersTab from './tabs/allowFiltersTab'
    ...
    export default {
        ...
        setup() {
            ...
            const blankFormData = {
                ...
                lateMarkDetail:{
                    lateMark_setup_enable_disable:false,
            ...
            /*
            await store.dispatch('hr-store-module/updateShiftDefinition', formData.value).then((res) => {
                if (res.status === 200) {
                    toast({
                        ...
                        props: {
                            ...
                            variant: 'success',
                            text: 'You have successfully Updated Shift Definition',
                        },
                    })
                } else {
                    toast({
