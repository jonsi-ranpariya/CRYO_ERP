                ...
                <b-row>
                    <b-col md="12">
                        <b-form-checkbox
                            ...
                            v-model="formData.employee_with_all_shift_Assign"
                        >
                            Do not show employee with all shift assigned.
                        </b-form-checkbox>
                    </b-col>
                </b-row>
                <hr>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const getFormDate = () => {
                let today = formData.value.from_date;
                let toDay = moment(today, "DD/MM/YYYY").add(35, 'days').format("DD/MM/YYYY");
                formData.value.to_date = toDay;
                // console.log(today);
                // console.log(toDay);
            }
