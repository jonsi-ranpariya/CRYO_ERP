            ...
            <validation-observer #default="{handleSubmit}">
                <b-form @submit.prevent="handleSubmit(saveFormData)">
                    ...
                    <b-col md="12">
                        ...
                        >
                            Upload Extra Flags in Attendance Muster
                        </b-button>
                        <b-button
                            variant="primary"
                            class="float-right"
...
<script>
    ...
    export default {
        ...
        setup({importModal}) {
            ...
            const machineNameOptions = ref([
                {label:'49.35.177,178', value:1},
                {label:'27.61.178.181', value:2},
            ])

            const shiftOptions = ref([
                {label:'1:00PM ~   6:00PM-13', value:1},
                {label:'9:00AM ~   1:00PM-13', value:2},
            ])
