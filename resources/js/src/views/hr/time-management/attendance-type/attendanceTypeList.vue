            ...
            <b-card-code>
                ...
                >
                    <template
                        ...
                        slot-scope="props"
                    >
                        <span v-if="props.column.field === 'colorCodeInput'">
                            <b-form-input type="color" disabled :value="props.row.color" />
                        </span>
                        <!-- Column: Action -->
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{name: 'edit-attendance-type', params:{id: props.row._id}}">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteAttendanceType(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
        ...
        setup() {
            ...
            const deleteAttendanceType = async (id) => {
                /*  Swal.fire({
                      ...
                      if (result.value) {
                          store.dispatch(`hr-store-module/deleteAttendanceType`, {id: id}).then(res => {
                              if (res.status === 200) {
                                  toast({
                                      ...
                                      props: {
                                          ...
                                          variant: 'success',
                                          text: 'You have successfully Deleted Attendance Type,
                                      },
                                  })
                              } else {
                                  toast({
