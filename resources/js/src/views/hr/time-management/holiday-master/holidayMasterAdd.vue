                            ...
                            <b-row>
                                <b-col md="8">
                                    ...
                                    >
                                        ...
                                        >
                                            <label for="calendar_name">Calendar Name <span
    ...
    export default {
        ...
        setup() {
            ...
            const saveFormData = async () => {
                ...
                router.push({name: 'edit-holiday-master'})
                /*    await store.dispatch('hr-store-module/addHolidayMaster', formData.value)
                       .then(res => {
                           if (res.status === 200) {
                               toast({
                                   ...
                                   props: {
                                       ...
                                       variant: 'success',
                                       text: `You have successfully Added Holiday Master.`,
                                   },
                               })
                           } else {
                               toast({
