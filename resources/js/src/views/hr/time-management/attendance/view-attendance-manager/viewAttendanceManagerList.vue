<template>
    <div>
        ...
        <b-modal
            id="viewAttendanceManagerModal"
            ref="viewAttendanceManagerModal"
...
<script>
    ...
    export default {
        ...
        setup({viewAttendanceManagerModal}) {
            viewAttendanceManagerModal = ref()

            const openModal = () => {
                viewAttendanceManagerModal.value.show();
            }
