            ...
            <b-card-code>
                <b-row class="mb-1">
                    <b-col cols="12" md="6" class="d-flex justify-content-start align-items-center">
                        <b-button
                            variant="primary"
                            :to="{ name: 'add-wo-shortage-purchase-items-wo-wise'}"
                        >
                            Add WO Purchase Items
                        </b-button>
                    </b-col>
                    <b-col cols="12" md="6">
                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item
                              :to="{ name: 'edit-wo-shortage-purchase-items-wo-wise', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteWoPurchaseItem(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/mrp/wo-wise-purchase-items').then(res => {
            ...
            const deleteWoPurchaseItem = async (id) => {
                Swal.fire({
                    title: 'Are you sure?',
                        ...
                        store.dispatch('mrp-store-module/deleteWoWisePurchaseItem',{id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    ...
                                    position: 'top-right',
                                    props: {
                                        title: 'Wo Purchase Item Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Wo Wise Purchase Item',
                                    },
                                })
                            } else {
                                toast({
