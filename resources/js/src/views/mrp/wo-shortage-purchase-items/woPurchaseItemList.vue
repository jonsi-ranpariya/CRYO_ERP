            ...
            <b-card-code>
                <b-row class="mb-1">
                    <b-col cols="12" md="6" class="d-flex justify-content-start align-items-center">
                        <b-button
                            variant="primary"
                            :to="{ name: 'add-wo-shortage-purchase-items'}"
                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item
                              :to="{ name: 'edit-wo-shortage-purchase-items', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await store.dispatch('mrp-store-module/getWoPurchaseItem').then(res => {
            ...
            const deleteWoPurchaseItem = async (id) => {
                Swal.fire({
                    ...
                    if (result.value) {
                        store.dispatch('mrp-store-module/deleteWoPurchaseItem',{id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: 'You have successfully Deleted Wo Purchase Item',
                                    },
                                })
                            } else {
                                toast({
