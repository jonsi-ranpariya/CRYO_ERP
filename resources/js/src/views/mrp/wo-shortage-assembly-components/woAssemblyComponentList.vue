        ...
        <b-card-code>
         <b-row class="mb-1">
             <b-col cols="12" md="6" class="d-flex justify-content-start align-items-center">
                 <b-button
                     variant="primary"
                     :to="{ name: 'add-wo-assembly-components'}"
                 > Add WO Assembly Components
                 </b-button>
             </b-col>
             <!-- ---------------search ---------------->
             <b-col cols="12" md="6">
                    ...
                    <span v-if="props.column.field === 'action'">
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item
                              :to="{ name: 'edit-wo-assembly-components', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await store.dispatch('mrp-store-module/getWoAssemblyComponent').then(res => {
            ...
            const deleteWoAssemblyComponent = async (id) => {
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Wo Assembly Component",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch('mrp-store-module/deleteWoAssemblyComponent',{id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    component: Toastification,
                                    position: 'top-right',
                                    props: {
                                        title: 'Wo Assembly Component Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Wo Assembly Component',
                                    },
                                })
                            } else {
                                toast({
