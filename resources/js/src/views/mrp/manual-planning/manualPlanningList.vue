                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{ name: 'edit-manual-planning', params: { id: props.row._id} }">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteManualPlanning(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await store.dispatch('mrp-store-module/getManualPlanning').then(res => {
            ...
            const deleteManualPlanning = async (id) => {
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Manual Planning",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch('mrp-store-module/deleteManualPlanning',{id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
                                    component: Toastification,
                                    position: 'top-right',
                                    props: {
                                        title: 'Manual Planning Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Manual Planning',
                                    },
                                })
                            } else {
                                toast({
