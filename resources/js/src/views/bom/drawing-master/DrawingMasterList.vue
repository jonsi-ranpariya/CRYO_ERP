            ...
            <b-card-code>
                ...
                <b-row class="mb-2">
                    ...
                    >
                        ...
                        <b-button
                            variant="primary"
                            :to="{ name: 'add-drawing-master'}"
                        >
                            Add New Drawing Master
                        </b-button>
                    </b-col>
                    <b-col
                        cols="12"
        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'drawingNo'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.drawingNo }}</span>
        </span>
          ...
          <span>
            ...
            >
              ...
              <b-dropdown-item :to="{ name: 'edit-drawing-master', params: { id: props.row._id} }">
                <feather-icon
                    icon="Edit2Icon"
                    class="mr-50"
                />
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/drawing-master').then(res => {
        ...
        created() {
            ...
            this.$http.get('/api/drawing-master')
                .then(res => {
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`dm-module/deleteDrawingMaster`, {id}).then(response => {
                            ...
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Drawing Master Deleted Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
