<template>
    ...
    >
        <div>
            <group-master-add-edit
                :groupFormData.sync="formData"
            ...
            <b-card-code>
                ...
                <vue-good-table
                    ...
                    :rows="$store.getters['hrMasterStoreModule/getGroupMasterList']"
                    :line-numbers="true"
                    :rtl="direction"
                    :search-options="{
                        enabled: true,
                    ...
                    >
                        ...
                        <span v-if="props.column.field === 'action'"><span>
                            ...
                            >
                              ...
                              <b-dropdown-item @click="editGroupMaster(props.row)">
                                <feather-icon
                                    icon="Edit2Icon"
                                    class="mr-50"
                                />
...
<script>
    ...
    import groupMasterAddEdit from './groupMasterAddEdit'
    ...
    export default {
        ...
        setup() {
            ...
            store.dispatch('hrMasterStoreModule/listGroupMaster');
            ...
            const addEditGroupMaster = async () => {
                await store.commit('hrMasterStoreModule/sideBarShowHide', true);
            }

            const editGroupMaster = async (data) => {
                formData.value = data;
                await store.commit('hrMasterStoreModule/sideBarShowHide', true);
            }
            const deleteGroupMasterData = async (id) => {
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Group Master",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch('hrMasterStoreModule/deleteGroupMaster', {id: id})
                            .then(res => {
                                if (res.status === 200) {
                                    toast({
                                        ...
                                        position: 'top-right',
                                        props: {
                                            title: 'Group Master Deleted',
                                            icon: 'CheckSquareIcon',
                                            variant: 'success',
                                            text: 'You have successfully Deleted Group Master',
                                        },
                                    })
                                }
                            }).catch(() => {
