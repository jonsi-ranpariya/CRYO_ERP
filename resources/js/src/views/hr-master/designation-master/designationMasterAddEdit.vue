...
<script>
    ...
    export default {
        ...
        setup(props, {emit}) {
            ...
            const formData = computed(() => props.designationFormData);
            ...
            const saveFormData = async () => {
                if (formData.value._id === null) {
                    await store.dispatch('hrMasterStoreModule/insertDesignationMaster', formData.value)
                        .then((res) => {
                            if (res.status === 201) {
                                toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: 'You have successfully Created New Designation Master',
                                    },
                                });
                            }
                        }).catch(() => {
                    ...
                    await store.dispatch('hrMasterStoreModule/updateDesignationMaster', formData.value)
                        .then((res) => {
                            if (res.status === 200) {
                                toast({
                                    component: ToastificationContent,
                                    ...
                                    props: {
                                        ...
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: `You have successfully Updated Designation Master.`,
                                    },
                                });
                            }
                        }).catch(() => {
                ...
                await resetFormData();
                await store.dispatch('hrMasterStoreModule/listDesignationMaster');
            }
