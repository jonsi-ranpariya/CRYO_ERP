...
<script>
    ...
    export default {
        ...
        setup(props, {emit}) {
            ...
            const formData = computed(() => props.categoryFormData);
            ...
            const saveFormData = async () => {
                if (formData.value._id === null) {
                    await store.dispatch('hrMasterStoreModule/insertCategoryMaster', formData.value)
                        .then((res) => {
                            if (res.status === 201) {
                                toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: 'You have successfully Created New Category Master',
                                    },
                                });
                            }
                        }).catch(() => {
                    ...
                    await store.dispatch('hrMasterStoreModule/updateCategoryMaster', formData.value)
                        .then((res) => {
                            if (res.status === 200) {
                                toast({
                                    component: ToastificationContent,
                                    ...
                                    props: {
                                        ...
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: `You have successfully Updated Category Master.`,
                                    },
                                });
                            }
                        }).catch(() => {
                ...
                await resetFormData();
                await store.dispatch('hrMasterStoreModule/listCategoryMaster');
            }
