...
<script>
    ...
    export default {
        ...
        setup(props, {emit}) {
            ...
            const formData = computed(() => props.gradeFormData);
            ...
            const saveFormData = async () => {
                if (formData.value._id === null) {
                    await store.dispatch('hrMasterStoreModule/insertGradeMaster', formData.value)
                        .then((res) => {
                            if (res.status === 201) {
                                toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: 'You have successfully Created New Grade Master',
                                    },
                                });
                            }
                        }).catch(() => {
                    ...
                    await store.dispatch('hrMasterStoreModule/updateGradeMaster', formData.value)
                        .then((res) => {
                            if (res.status === 200) {
                                toast({
                                    component: ToastificationContent,
                                    ...
                                    props: {
                                        ...
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: `You have successfully Updated Grade Master.`,
                                    },
                                });
                            }
                        }).catch(() => {
                ...
                await resetFormData();
                await store.dispatch('hrMasterStoreModule/listGradeMaster');
                  }
