...
<script>
    ...
    export default {
        ...
        setup(props, {emit}) {
            ...
            const formData = computed(() => props.divisionFormData);
            ...
            const saveFormData = async () => {
                if (formData.value._id === null) {
                    await store.dispatch('hrMasterStoreModule/insertDivisionMaster', formData.value)
                        .then((res) => {
                            if (res.status === 201) {
                                toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: 'You have successfully Created New Division Master',
                                    },
                                });
                            }
                        }).catch(() => {
                    ...
                    await store.dispatch('hrMasterStoreModule/updateDivisionMaster', formData.value)
                        .then((res) => {
                            if (res.status === 200) {
                                toast({
                                    component: ToastificationContent,
                                    ...
                                    props: {
                                        ...
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: `You have successfully Updated Division Master.`,
                                    },
                                });
                            }
                        }).catch(() => {
                ...
                await resetFormData();
                await store.dispatch('hrMasterStoreModule/listDivisionMaster');
            }
