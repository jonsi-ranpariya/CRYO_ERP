<template>
    ...
    >
        <div>
            <division-master-add-edit
                :divisionFormData.sync="formData"
            ...
            <b-card-code>
                ...
                <vue-good-table
                    ...
                    :rows="$store.getters['hrMasterStoreModule/getDivisionMasterList']"
                    :line-numbers="true"
                    :rtl="direction"
                    :search-options="{
                        enabled: true,
                    ...
                    >
                        ...
                        <span v-if="props.column.field === 'action'"><span>
                            ...
                            >
                              ...
                              <b-dropdown-item @click="editDivisionMaster(props.row)">
                                <feather-icon
                                    icon="Edit2Icon"
                                    class="mr-50"
                                />
                              ...
                              <b-dropdown-item @click="deleteDivisionMasterData(props.row._id)">
                                <feather-icon
                                    icon="TrashIcon"
                                    class="mr-50"
                                />
...
<script>
    ...
    import divisionMasterAddEdit from './divisionMasterAddEdit'
    ...
    export default {
        ...
        setup() {
            ...
            store.dispatch('hrMasterStoreModule/listDivisionMaster');
            ...
            const addEditDivisionMaster = async () => {
                await store.commit('hrMasterStoreModule/sideBarShowHide', true);
            }

            const editDivisionMaster = async (data) => {
                formData.value = data;
                await store.commit('hrMasterStoreModule/sideBarShowHide', true);
            }

            const deleteDivisionMasterData = async (id) => {
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Division Master",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch('hrMasterStoreModule/deleteDivisionMaster', {id: id})
                            .then(res => {
                                if (res.status === 200) {
                                    toast({
                                        ...
                                        position: 'top-right',
                                        props: {
                                            title: 'Division Master Deleted',
                                            icon: 'CheckSquareIcon',
                                            variant: 'success',
                                            text: 'You have successfully Deleted Division Master',
                                        },
                                    })
                                }
                            }).catch(() => {
            ...
            return {
                formData,
                resetFormData,
                addEditDivisionMaster,
                editDivisionMaster,
                deleteDivisionMasterData,
                tableData
            }
        }
    }
