<template>
    ...
    >
        <div>
            <department-master-add-edit
                :departmentFormData.sync="formData"
            ...
            <b-card-code>
                ...
                <vue-good-table
                    ...
                    :rows="$store.getters['hrMasterStoreModule/getDepartmentMasterList']"
                    :line-numbers="true"
                    :rtl="direction"
                    :search-options="{
                        enabled: true,
                    ...
                    >
                        ...
                        <span v-if="props.column.field === 'action'"><span>
                            ...
                            >
                              ...
                              <b-dropdown-item @click="editDepartmentMaster(props.row)">
                                <feather-icon
                                    icon="Edit2Icon"
                                    class="mr-50"
                                />
                              ...
                              <b-dropdown-item @click="deleteDepartmentMasterData(props.row._id)">
                                <feather-icon
                                    icon="TrashIcon"
                                    class="mr-50"
                                />
...
<script>
    ...
    import departmentMasterAddEdit from "./departmentMasterAddEdit";
    ...
    export default {
        ...
        setup() {
            ...
            store.dispatch('hrMasterStoreModule/listDepartmentMaster');
            ...
            const addEditDepartmentMaster = async () => {
                await store.commit('hrMasterStoreModule/sideBarShowHide', true);
            }

            const editDepartmentMaster = async (data) => {
                formData.value = data;
                await store.commit('hrMasterStoreModule/sideBarShowHide', true);
            }
            const deleteDepartmentMasterData = async (id) => {
                Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Department Master",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch('hrMasterStoreModule/deleteDepartmentMaster', {id: id})
                            .then(res => {
                                if (res.status === 200) {
                                    toast({
                                        ...
                                        position: 'top-right',
                                        props: {
                                            title: 'Department Master Deleted',
                                            icon: 'CheckSquareIcon',
                                            variant: 'success',
                                            text: 'You have successfully Deleted Department Master',
                                        },
                                    })
                                }
                            }).catch(() => {
            ...
            return {
                formData,
                resetFormData,
                addEditDepartmentMaster,
                editDepartmentMaster,
                deleteDepartmentMasterData,
                tableData
            }
        }
    }
