...
<script>
    ...
    export default {
        ...
        setup(props, {emit}) {
            ...
            const formData = computed(() => props.departmentFormData);
            ...
            const saveFormData = async () => {
                if (formData.value._id === null) {
                    await store.dispatch('hrMasterStoreModule/insertDepartmentMaster', formData.value)
                        .then((res) => {
                            if (res.status === 201) {
                                toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: 'You have successfully Created New Department Master',
                                    },
                                });
                            }
                        }).catch(() => {
                    ...
                    await store.dispatch('hrMasterStoreModule/updateDepartmentMaster', formData.value)
                        .then((res) => {
                            if (res.status === 200) {
                                toast({
                                    component: ToastificationContent,
                                    ...
                                    props: {
                                        ...
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: `You have successfully Updated Department Master.`,
                                    },
                                });
                            }
                        }).catch(() => {
                ...
                await resetFormData();
                await store.dispatch('hrMasterStoreModule/listDepartmentMaster');
            }
