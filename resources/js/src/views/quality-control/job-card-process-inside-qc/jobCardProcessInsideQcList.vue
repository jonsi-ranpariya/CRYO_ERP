        ...
        <b-card-code>
            <b-row class="mb-1">
                <b-col cols="12" md="6" class="d-flex justify-content-start align-items-center">
                    <b-button
                        variant="primary"
                        :to="{ name: 'add-job-card-process-inside-qc'}"
                    > Add Job Card Process Inside QC
                    </b-button>
                </b-col>
                <!-----------------search ---------------->
                <b-col cols="12" md="6">
                    ...
                    <span v-if="props.column.field === 'action'">
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{ name:'edit-job-card-process-inside-qc', params:{id: props.row._id}}">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteJobCardInsideQc(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/new/job-card-process-inside-qc').then(res => {
            ...
            const deleteJobCardInsideQc = async (id) => {
                await Swal.fire({
                    title: 'Are you sure?',
                    text: "Delete Job Card Process Inside QC",
                    icon: 'warning',
                    ...
                    if (result.value) {
                        store.dispatch('quality-control-store-module/deleteJobCardProcessInsideQc', {id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
