    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                ...
                await axios.get(`/api/new/job-card-process-inside-qc/${router.currentRoute.params.id}`).then((res) => {
            ...
            const saveFormData = async () => {
                ...
                await store.dispatch('quality-control-store-module/updateJobCardProcessInsideQc', formData.value).then(res => {
                    if (res.status === 200) {
                        toast({
                            component: ToastificationContent,
                            position: 'top-right',
                            props: {
                                title: 'Job Card Process Inside QC Updated',
                                icon: 'CheckSquareIcon',
                                variant: 'success',
                                text: 'You have successfully Updated Job Card Process Inside Qc',
                            },
                        })
                    } else {
                        toast({
