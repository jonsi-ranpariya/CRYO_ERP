                            ...
                            >
                                ...
                                >
                                    <b-input-group class="d-flex">
                                        ...
                                        />
                                        <b-input-group-append>
                                            <b-button variant="primary" @click="openModalItemDetails">...</b-button>
                                        </b-input-group-append>
                                    </b-input-group>
                                    <b-form-invalid-feedback :state="getValidationState(validationContext)">
                                        {{ validationContext.errors[0] }}
...
export default {
    ...
    setup({woItemMasterModal}) {
        ...
        const selectWorkOrderItem = async (data) => {
            ...
            formData.value.requiredQty = data?.woQty ?? null
        ...
        const saveFormData = async () => {
            await store.dispatch('quality-control-store-module/addWorkOrderSubAssemblyQc', formData.value).then(res => {
                if (res.status === 200) {
                    toast({
                        component: ToastificationContent,
                        position: 'top-right',
                        props: {
                            title: 'Work Order Sub-Assembly Quality Control Added',
                            icon: 'CheckSquareIcon',
                            variant: 'success',
                            text: `You have successfully Added Work Order Sub-Assembly Quality Control.`,
                        },
                    })
                } else {
                    toast({
