...
<script>
    ...
    import inspectionRemarkTab from './tabs/inspectionDetailsTab';
    ...
    export default {
        ...
        setup(){
            ...
            const refetchData = async () => {
                ...
                await axios.get(`/api/new/finished-good-quality-control/${router.currentRoute.params.id}`).then((res) => {
            ...
            const saveFormData = async () => {
                ...
                await store.dispatch('quality-control-store-module/updateFinishedGoodQualityControl', formData.value).then(res => {
                    if (res.status === 200) {
                        toast({
                            component: ToastificationContent,
                            position: 'top-right',
                            props: {
                                title: 'Finished Good Quality Control Updated',
                                icon: 'CheckSquareIcon',
                                variant: 'success',
                                text: 'You have successfully Updated Finished Good quality Control',
                            },
                        })
                    } else {
                        toast({
