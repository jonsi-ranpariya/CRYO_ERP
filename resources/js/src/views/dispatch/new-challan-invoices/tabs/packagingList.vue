    ...
    export default {
        ...
        setup() {
            ...
            const refetchData = async () => {
                isBusy.value = true
                await axios.get(`/api/new-challan-packing-list/${router.currentRoute.params.id}`).then((res) => {
            ...
            const getItemDetails = async (id) => {
                await axios.get(`/api/new-challan-and-invoice-item/${id}`).then((res) => {
                    ...
                    formData.value.msnNumber = res.data.data.itemMsnNumber
                    formData.value.custPartNo = res.data.data.itemCustPartNo
                });
            }
            ...
            const deletePackingItemdetails = async (id) => {
                await Swal.fire({
                    ...
                    if (result.value) {
                        store.dispatch('dispatch-store-module/deleteNewInvoiceChallanPacking', {id: id}).then((res) => {
                            if (res.status === 200) {
                                toast({
                                    component: ToastificationContent,
                                    position: 'top-right',
                                    props: {
                                        title: 'Challan & Invoice Packing Item Deleted',
                                        icon: 'CheckSquareIcon',
                                        variant: 'success',
                                        text: 'You have successfully Deleted Challan & Invoice Packing Item',
                                    },
                                });
                            } else {
                                toast({
            ...
            const saveFormData = async () => {
                if (formData.value._id === null){
                    await store.dispatch('dispatch-store-module/addNewInvoiceChallanPacking', formData.value).then((res) => {
                        if (res.status === 200) {
                            toast({
                                component: ToastificationContent,
                                position: 'top-right',
                                props: {
                                    title: 'Challan & Invoice Packing Item Added',
                                    icon: 'CheckSquareIcon',
                                    variant: 'success',
                                    text: 'You have successfully Added Packing Item',
                                },
                            });
                        } else {
                            toast({
                    ...
                    await store.dispatch('dispatch-store-module/updateNewInvoiceChallanPacking', formData.value).then((res) => {
                        if (res.status === 200) {
                            toast({
                                component: ToastificationContent,
                                position: 'top-right',
                                props: {
                                    title: 'Challan & Invoice Packing Item Updated',
                                    icon: 'CheckSquareIcon',
                                    variant: 'success',
                                    text: 'You have successfully Updated Packing Item',
                                },
                            });
                        } else {
                            toast({
