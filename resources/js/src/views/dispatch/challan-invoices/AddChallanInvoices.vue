            ...
            validationForm() {
                this.$refs.simpleRules.validate().then(success => {
                    if (success) {
                        ...
                        store.dispatch('dispatch-challan-invoices/addInvoiceChallan', this.invoiceFormData).then(response => {

                            //console.log(response);

                            if(response.status = 200) {

                                this.$router.push({ name: 'edit-challan-invoices', params: { id: response.data.data._id } })
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `You have successfully Created New Invoice ${this.invoiceFormData.invoiceNo}.`,
                                    },
                                })
                            }
