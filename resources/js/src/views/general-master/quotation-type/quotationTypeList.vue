...
<script>
    ...
    import QuotationTypeAddEdit from "./quotationTypeAddEdit";

    export default {
        components: {
            QuotationTypeAddEdit,
            BCardCode,
            BOverlay,
            VueGoodTable,
            BButton,
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/quotation-type').then(res => {
        ...
        setup() {
            const COUNTRY_APP_STORE_MODULE_NAME = 'quotation-type-module'
            // Register module
        ...
        methods: {
            ...
            deleteMyCurrentErpData(id) {
                this.$swal({
                    ...
                    if (result.value) {
                        store.dispatch(`quotation-type-module/deleteQuotationType`, {id}).then(response => {
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Quotation Type Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
