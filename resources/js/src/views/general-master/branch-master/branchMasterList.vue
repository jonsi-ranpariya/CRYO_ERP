        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'branchName'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.branchName }}</span>
...
<script>
    ...
    import branchMasterAddNew from './branchMasterAddNew.vue'
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/branch-master').then(res => {
        ...
        setup() {
            ...
            const BRANCH_APP_STORE_MODULE_NAME = 'branch-module'

            // Register module
            if (!store.hasModule(BRANCH_APP_STORE_MODULE_NAME)) store.registerModule(BRANCH_APP_STORE_MODULE_NAME, generalMasterStoreModule)
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`branch-module/deleteBranchMaster`, {id}).then(response => {
