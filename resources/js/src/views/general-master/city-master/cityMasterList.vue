        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'city'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.city }}</span>
          ...
          <span class="text-nowrap">{{ getStateName(props.row.state) }}</span>
        </span>
...
<script>
    ...
    import cityMasterAddNew from './cityMasterAddNew.vue'
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/city-master').then(res => {
        ...
        setup() {
            ...
            const CITY_APP_STORE_MODULE_NAME = 'city-module'

            // Register module
            if (!store.hasModule(CITY_APP_STORE_MODULE_NAME)) store.registerModule(CITY_APP_STORE_MODULE_NAME, generalMasterStoreModule)
        ...
        methods: {
            ...
            getStateName(cat) {
                ...
                var valObj = this.stateOptions.filter(function (elem) {
                    if (elem.value === cat) {
                        return elem.label
                    }
                })
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`city-module/deleteCityMaster`, {id}).then(response => {
