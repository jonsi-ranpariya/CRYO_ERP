...
<script>
    ...
    import itemMakeMasterListAddNew from './itemMakeMasterListAddNew.vue'

    export default {
        components: {
            itemMakeMasterListAddNew,
            BCardCode,
            BOverlay,
            VueGoodTable,
            BButton,
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/item-make-master')
                    .then(res => {
        ...
        setup() {
            ...
            const ITEMMAKE_APP_STORE_MODULE_NAME = 'item-make-module'

            // Register module
            if (!store.hasModule(ITEMMAKE_APP_STORE_MODULE_NAME)) store.registerModule(ITEMMAKE_APP_STORE_MODULE_NAME, generalMasterStoreModule)

            // UnRegister on leave
            onUnmounted(() => {
                if (store.hasModule(ITEMMAKE_APP_STORE_MODULE_NAME)) store.unregisterModule(ITEMMAKE_APP_STORE_MODULE_NAME)
            })
        },
        computed: {
            direction() {
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`item-make-module/deleteItemMakeMaster`, { id }).then(response => {
