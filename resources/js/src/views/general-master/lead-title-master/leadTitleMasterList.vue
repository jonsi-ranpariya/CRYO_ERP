            ...
            <b-card-code>
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'leadTitle'"
                            class="text-nowrap"
                        >
                            <span class="text-nowrap">{{ props.row.leadTitle }}</span>
                        </span>
...
<script>
    ...
    import LeadTitleMasterAddEdit from "./leadTitleMasterAddEdit";

    export default {
        components: {
            LeadTitleMasterAddEdit,
            BCardCode,
            BOverlay,
            VueGoodTable,
            BButton,
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/lead-title-master').then(res => {
        ...
        setup() {
            const COUNTRY_APP_STORE_MODULE_NAME = 'lead-title-master'
            // Register module
        ...
        methods: {
            ...
            deleteMyCurrentErpData(id) {
                this.$swal({
                    ...
                    if (result.value) {
                        store.dispatch(`lead-title-master/deleteLeadTitleMaster`, {id}).then(response => {
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Lead Title Master Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
