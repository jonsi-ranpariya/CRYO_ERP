        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'expense'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.expense }}</span>
...
<script>
    ...
    import expenseMasterAddNew from './expenseMasterAddNew.vue'
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/expense-master').then(res => {
        ...
        setup() {
            ...
            const EXPENSE_APP_STORE_MODULE_NAME = 'expense-module'

            // Register module
            if (!store.hasModule(EXPENSE_APP_STORE_MODULE_NAME)) store.registerModule(EXPENSE_APP_STORE_MODULE_NAME, generalMasterStoreModule)
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`expense-module/deleteExpenseMaster`, {id}).then(response => {
