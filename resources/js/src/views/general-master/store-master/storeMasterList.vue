<template>
    ...
    >
        ...
        perPage:pageLength
          ...
          <span class="text-nowrap">{{ props.row.storeName }}</span>
...
<script>
    ...
    import storeMasterAddEdit from './storeMasterAddEdit.vue'
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/store-master').then(res => {
        ...
        setup() {
            ...
            const STORE_APP_STORE_MODULE_NAME = 'store-module'

            // Register module
            if (!store.hasModule(STORE_APP_STORE_MODULE_NAME)) store.registerModule(STORE_APP_STORE_MODULE_NAME, generalMasterStoreModule)
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`store-module/deleteStoreMaster`, {id}).then(response => {
