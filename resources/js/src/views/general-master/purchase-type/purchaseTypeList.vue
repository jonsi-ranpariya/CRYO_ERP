            ...
            <b-card-code>
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'purchaseType'"
                            class="text-nowrap"
                        >
                            <span class="text-nowrap">{{ props.row.purchaseType }}</span>
                        </span>
...
<script>
    ...
    import PurchaseTypeAddEdit from "./purchaseTypeAddEdit";
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/purchase-type').then(res => {
        ...
        setup() {
            const COUNTRY_APP_STORE_MODULE_NAME = 'purchase-type'
            // Register module
        ...
        methods: {
            ...
            deleteMyCurrentErpData(id) {
                this.$swal({
                    ...
                    if (result.value) {
                        store.dispatch(`purchase-type/deletePurchaseType`, {id}).then(response => {
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Purchase Type Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
