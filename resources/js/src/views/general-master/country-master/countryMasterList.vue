<template>
    ...
    >
        ...
        perPage:pageLength
          ...
          <span class="text-nowrap">{{ props.row.country }}</span>
...
<script>
    ...
    import countryMasterAddNew from './countryMasterAddNew.vue'
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/country-master').then(res => {
        ...
        setup() {
            ...
            const COUNTRY_APP_STORE_MODULE_NAME = 'country-module'
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`country-module/deleteCountryMaster`, {id}).then(response => {
                            ...
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Country Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
