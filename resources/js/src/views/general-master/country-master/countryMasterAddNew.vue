    ...
    export default {
        ...
        methods: {
            ...
            saveMyERPData() {
                ...
                if (hasIdExist) {
                    axios.post('/api/new/country-master-exist',
                        {
                        ...
                        if (res.data.data === true) {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: 'Country Name' + this.userformData.country + ' Already Exist!',
                            })
                    ...
                    delete this.userformData._id
                            ...
                            store.dispatch('country-module/editCountryMasterData', this.userformData).then(response => {
                                ...
                                if (response.status = 200) {
                                    ...
                                    this.$toast({
                                        ...
                                        props: {
                                            ...
                                            variant: 'success',
                                            text: `You have successfully Edited Country : ${this.userformData.country}.`,
                                        },
                                    })
                                }
                    ...
                    axios.post('/api/new/country-master-exist',
                        ...
                        if (res.data.data === true) {
                            ...
                            store.dispatch('country-module/addCountryMasterData', this.userformData).then(response => {
                                ...
                                if (response.status = 200) {
                                    ...
                                    this.$toast({
                                        ...
                                        props: {
                                            ...
                                            icon: 'CheckSquareIcon',
                                            variant: 'success',
                                            text: `You have successfully Created New Country : ${this.userformData.country}.`,
                                        },
                                    })
                                }
