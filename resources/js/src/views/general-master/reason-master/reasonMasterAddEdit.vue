            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <v-select
                                v-model="userformData.reasonType"
        ...
        methods: {
            saveMyERPData() {
                ...
                if (hasIdExist) {
                    ...
                    store.dispatch('reason-type-module/updateReasonType', this.userformData).then(response => {
                        if (response.status = 200) {
                            ...
                            this.$toast({
                                ...
                                position: 'top-right',
                                props: {
                                    title: 'Reason Type Edited',
                                    icon: 'CheckSquareIcon',
                                    variant: 'success',
                                    text: `You have successfully Edited Reason Type : ${this.userformData.reason}.`,
                                },
                            })
                        }
                    })
                } else {
                    store.dispatch('reason-type-module/addReasonType', this.userformData).then(response => {
                        if (response.status = 200) {
                            this.$emit('refetch-data')
                            this.$emit('update:is-add-new-user-sidebar-active', false)
                            this.$toast({
                                ...
                                position: 'top-right',
                                props: {
                                    title: 'Reason Type Created',
                                    icon: 'CheckSquareIcon',
                                    variant: 'success',
                                    text: `You have successfully Created New Reason Type : ${this.userformData.reason}.`,
                                },
                            })
                        }
                    })
