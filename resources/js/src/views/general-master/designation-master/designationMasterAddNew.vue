        ...
        methods: {
            ...
            saveMyERPData() {
                ...
                if (hasIdExist) {
                    ...
                    axios.post('/api/new/designation-master-exist',
                        {
                            id: this.userformData._id,
                            designation: this.userformData.designation
                        }
                    ).then(res => {
                            if (res.data.data === true) {
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Oops...',
                                    text: 'Designation' + this.userformData.designation + ' Already Exist!',
                                })
                    ...
                    delete this.userformData._id
                            ...
                            store.dispatch('designation-module/editDesignationData', this.userformData).then(response => {
                                ...
                                if (response.status = 200) {
                                    ...
                                    this.$toast({
                                        ...
                                        position: 'top-right',
                                        props: {
                                            title: 'Designation Edited',
                                            icon: 'CheckSquareIcon',
                                            variant: 'success',
                                            text: `You have successfully Edited Designation : ${this.userformData.designation}.`,
                                        },
                                    })
                                }
                    ...
                    axios.post('/api/new/designation-master-exist',
                        ...
                        if (res.data.data === true) {
                            ...
                            store.dispatch('designation-module/addDesignationData', this.userformData).then(response => {
                                ...
                                if (response.status = 200) {
                                    ...
                                    this.$toast({
                                        ...
                                        props: {
                                            ...
                                            icon: 'CheckSquareIcon',
                                            variant: 'success',
                                            text: `You have successfully Created New Designation : ${this.userformData.designation}.`,
                                        },
                                    })
                                }
