<template>
    ...
    >
        <div>
            <document-footer-add-edit
                :is-add-new-user-sidebar-active.sync="isAddNewUserSidebarActive"
                :userform-data="userFormData"
                @refetch-data="refetchData"
                :document-footer-type-option="footerTypeOption"
            />
            ...
            <b-card-code>
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'footerName'"
                            class="text-nowrap"
                        >
                        ...
                        <span
                            v-if="props.column.field === 'footer'"
                            class="text-nowrap"
                        >
                            <span class="text-nowrap"></span>
                        </span>
                        ...
                        <span
                            v-if="props.column.field === 'footerType'"
                            class="text-nowrap"
                        >
                            <span class="text-nowrap">{{ getDocumentHeaderTypeName(props.row.footerType) }}</span>
                        </span>
...
<script>
    ...
    import DocumentFooterAddEdit from "./documentFooterAddEdit";

    export default {
        components: {
            DocumentFooterAddEdit,
            BCardCode,
            BOverlay,
            VueGoodTable,
            BButton,
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/document-footer').then(res => {
        ...
        setup() {
            const COUNTRY_APP_STORE_MODULE_NAME = 'document-footer-module'
        ...
        methods: {
            getDocumentHeaderTypeName(cat) {
                let valObj = this.footerTypeOption.filter(function (elem) {
                    if (elem.value === cat) {
                        return elem.label
                    }
                })
            ...
            deleteMyCurrentErpData(id) {
                this.$swal({
                    ...
                    if (result.value) {
                        store.dispatch(`document-footer-module/deleteDocumentFooter`, {id}).then(response => {
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Document Footer Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
