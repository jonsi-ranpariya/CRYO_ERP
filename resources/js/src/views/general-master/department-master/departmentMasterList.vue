        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'department'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.department }}</span>
...
<script>
    ...
    import departmentMasterAddNew from './departmentMasterAddNew.vue'

    export default {
        components: {
            departmentMasterAddNew,
            BCardCode,
            BOverlay,
            VueGoodTable,
            BButton,
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/department-master').then(res => {
        ...
        setup() {
            ...
            const DEPARTMENT_APP_STORE_MODULE_NAME = 'department-module'

            // Register module
            if (!store.hasModule(DEPARTMENT_APP_STORE_MODULE_NAME)) store.registerModule(DEPARTMENT_APP_STORE_MODULE_NAME, generalMasterStoreModule)
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`department-module/deleteDepartmentMaster`, {id}).then(response => {
