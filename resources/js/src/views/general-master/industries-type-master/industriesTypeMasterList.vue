<template>
    ...
    >
        <div>
            <industries-typ-master-add-edit
            ...
            <b-card-code>
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'industryType'"
                            class="text-nowrap"
                        >
                            <span class="text-nowrap">{{ props.row.industryType }}</span>
                        </span>
...
<script>
    ...
    import IndustriesTypMasterAddEdit from "./industriesTypMasterAddEdit";

    export default {
        components: {
            IndustriesTypMasterAddEdit,
            BCardCode,
            BOverlay,
            VueGoodTable,
            BButton,
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/industries-type-master').then(res => {
        ...
        setup() {
            const COUNTRY_APP_STORE_MODULE_NAME = 'industries-type-master'
            // Register module
        ...
        methods: {
            ...
            deleteMyCurrentErpData(id) {
                this.$swal({
                    ...
                    if (result.value) {
                        store.dispatch(`industries-type-master/deleteIndustriesTypeMaster`, {id}).then(response => {
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Industries Type Master Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
