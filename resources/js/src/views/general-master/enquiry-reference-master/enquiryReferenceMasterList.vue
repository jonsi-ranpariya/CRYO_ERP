<template>
    ...
    >
        <div>
            <enquiry-reference-master-add-edit
            ...
            <b-card-code>
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'enquiryReferenceName'"
                            class="text-nowrap"
                        >
                            <span class="text-nowrap">{{ props.row.enquiryReferenceName }}</span>
                        </span>
...
<script>
    ...
    import countryMasterAddNew from "../country-master/countryMasterAddNew";
    import generalMasterStoreModule from "../generalMasterStoreModule";
    import EnquiryReferenceMasterAddEdit from "./enquiryReferenceMasterAddEdit";

    export default {
        components: {
            EnquiryReferenceMasterAddEdit,
            countryMasterAddNew,
            BCardCode,
            BOverlay,
            VueGoodTable,
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/enquiry-reference').then(res => {
        ...
        setup() {
            const COUNTRY_APP_STORE_MODULE_NAME = 'enquiry-reference-module'
            // Register module
        ...
        methods: {
            ...
            deleteMyCurrentErpData(id) {
                this.$swal({
                    ...
                    if (result.value) {
                        store.dispatch(`enquiry-reference-module/deleteEnquiryReference`, {id}).then(response => {
                            if (response.data.status == '200') {
                                ...
                                this.$toast({
                                    ...
                                    props: {
                                        ...
                                        variant: 'success',
                                        text: `Enquiry Reference Delete Successfully`,
                                    },
                                })
                            } else {
                                this.$toast({
