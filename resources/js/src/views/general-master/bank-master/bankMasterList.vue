        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'bankName'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.bankName }}</span>

        </span>
                        <span
                            v-else-if="props.column.field === 'bankCity'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ getCityName(props.row.bankCity) }}</span>
        </span>
...
<script>
    ...
    import bankMasterAddNew from './bankMasterAddNew.vue'
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/bank-master').then(res => {
        ...
        setup() {
            ...
            const BANK_APP_STORE_MODULE_NAME = 'bank-module'

            // Register module
            if (!store.hasModule(BANK_APP_STORE_MODULE_NAME)) store.registerModule(BANK_APP_STORE_MODULE_NAME, generalMasterStoreModule)
        ...
        methods: {
            ...
            getCityName(cat) {
                ...
                var valObj = this.cityOptions.filter(function (elem) {
                    if (elem.value === cat) {
                        return elem.label
                    }
                })
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`bank-module/deleteBankMaster`, {id}).then(response => {
