        ...
        perPage:pageLength
                ...
                >
                    ...
                    >
                        ...
                        <!-- Column: Name -->
                        <span
                            v-if="props.column.field === 'noteName'"
                            class="text-nowrap"
                        >

          <span class="text-nowrap">{{ props.row.noteName }}</span>
        </span>
...
<script>
    ...
    import noteMasterAddNew from './noteMasterAddNew.vue'
    ...
    export default {
        ...
        data() {
            ...
            const refetchData = () => {
                ...
                this.$http.get('/api/note-master').then(res => {
        ...
        setup() {
            ...
            const NOTE_APP_STORE_MODULE_NAME = 'note-module'

            // Register module
            if (!store.hasModule(NOTE_APP_STORE_MODULE_NAME)) store.registerModule(NOTE_APP_STORE_MODULE_NAME, generalMasterStoreModule)

            // UnRegister on leave
            onUnmounted(() => {
                if (store.hasModule(NOTE_APP_STORE_MODULE_NAME)) store.unregisterModule(NOTE_APP_STORE_MODULE_NAME)
            })
        },
        computed: {
            direction() {
            ...
            deleteMyCurrentErpData(id) {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        ...
                        store.dispatch(`note-module/deleteNoteMaster`, {id}).then(response => {
