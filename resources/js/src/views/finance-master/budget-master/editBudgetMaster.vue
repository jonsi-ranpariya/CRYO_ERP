...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            store.dispatch('budget-master/fetchBudgetMaster', {id: router.currentRoute.params.id})
                .then(response => {
            ...
            const submitFormData = () => {
                store.dispatch('budget-master/updateBudgetMaster',formData.value).then(response => {
                    if (response.data.status === 200){
                        toast({
                            component: Toastification,
                            position: 'top-right',
                            props: {
                                title: 'Budget Master Updated',
                                icon: 'CheckSquareIcon',
                                variant: 'success',
                                text: 'You have successfully Updated Budget Master',
                            },
                        })
                    } else {
                        toast({
        ...
        methods: {
            changeAccountGroupOption(type){
                ...
                this.formData.january = null
                this.formData.february = null
                this.formData.march = null
                this.formData.april = null
                this.formData.may = null
                this.formData.june = null
                this.formData.july = null
                this.formData.august = null
                this.formData.september = null
                this.formData.october = null
                this.formData.november = null
                this.formData.december = null
                this.formData.monthlyBudget = null
                this.formData.yearlyBudget = null
