...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submitFormData() {
                this.$store.dispatch('master-add/addGeneralLedgerMaster',this.formData).then(response => {
                    this.$toast({
                        component: Toastification,
                        position: 'top-right',
                        props: {
                            title: 'Add General Ledger created',
                            icon: 'CheckSquareIcon',
                            variant: 'success',
                            text: `You have successfully Created General Ledger : ${this.formData.accountName}.`,
                        },
                    })
