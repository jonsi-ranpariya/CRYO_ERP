<template>
    <b-row :style="nodeMargin">
        <b-col cols="12">
            ...
            <div>
                <add-cost-center-group-modal :itemId="node.d_id"/>
                <edit-cost-center-group-modal :itemId="node.d_id" :itemData="node"/>
            </div>
        </b-col>
    </b-row>
</template>
<script>
    ...
    import AddCostCenterGroupModal from "./addCostCenterGroupModal";
    import EditCostCenterGroupModal from "./editCostCenterGroupModal";

    export default {
        name: 'TreeNode',
        components: {
            EditCostCenterGroupModal,
            AddCostCenterGroupModal,
            BAlert,
            BRow,
            BCol,
            BButton,
