...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submitFormData() {
                store.dispatch('master-add/addChartOfAccounts', this.formData)
                    .then(response => {
                    if (response.status == 200) {
                        ...
                        this.$toast({
                            ...
                            position: 'top-right',
                            props: {
                                title: 'Charts of Account Created',
                                icon: 'CheckSquareIcon',
                                variant: 'success',
                                text: `You have successfully Created New Chart Of Account : ${this.formData.groupName}.`,
                            },
                        })
                        this.$forceUpdate()
                        this.resetFormData()
