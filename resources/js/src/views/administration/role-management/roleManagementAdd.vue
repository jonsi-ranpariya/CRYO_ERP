                        ...
                        <b-col md="4">
                            ...
                            >
                                <b-form-group>
                                    <label
                                        for="role_name"
                                    >Role Name <span class="text-danger erp_required_star">*</span>
                                    </label>
                                    <b-form-input
                                        id="role_name"
...
export default {
    ...
    setup() {
        ...
        const saveFormData = async () => {
            await axios.post('/api/role-management', formData.value)
                .then((res) => {
                    if (res.status === 200) {
                        toast({
                            ...
                            position: 'top-right',
                            props: {
                                title: 'Role Details Added',
                                icon: 'CheckSquareIcon',
                                variant: 'success',
                                text: 'You have successfully Created Role Details.',
                            },
                        })
                        router.push({ name: 'edit-role-management', params: {id: res.data.data._id} })
                    } else {
                        toast({
                            component: ToastificationContent,
                            position: 'top-right',
