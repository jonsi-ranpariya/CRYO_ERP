    ...
    export default {
        ...
        setup() {
            ...
            const getData = async () => {
                ...
                await axios.get(`/api/administration/company/${router.currentRoute.params.id}`).then(res => {
            ...
            const saveFormData = async () => {
                ...
                await store.dispatch('administration-store-module/updateCompanyDetails', formData.value).then(res => {
                    if (res.status === 200) {
                        toast({
                    ...
                    router.push({name: 'company-details'})
                })
            }
