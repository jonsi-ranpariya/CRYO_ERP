                    ...
                    >
                      ...
                      <span>
                        ...
                        >
                          ...
                          <b-dropdown-item :to="{name: 'edit-company-details', params:{id: props.row._id}}">
                            <feather-icon
                                icon="Edit2Icon"
                                class="mr-50"
                            />
                          ...
                          <b-dropdown-item @click="deleteCompany(props.row._id)">
                            <feather-icon
                                icon="TrashIcon"
                                class="mr-50"
                            />
    ...
    export default {
        ...
        setup() {
            ...
            const columns = ref([
                ...
                {
                    label: 'City',
                    field: 'city_data.city',
                },
                {
                    label: 'State',
                    field: 'state_data.state',
                },
                {
                    label: 'Currency',
                    field: 'currency_data.currencyCode',
                },
                {
                    label: 'Action',
                    field: 'action',
            ...
            const refetchData = async () => {
                ...
                await axios.get('/api/administration/company').then((res) => {
            ...
            const deleteCompany = async (id) => {
                await Swal.fire({
                    ...
                    if (result.value) {
                        store.dispatch('administration-store-module/deleteCompanyDetails', {id: id}).then(res => {
                            if (res.status === 200) {
                                toast({
